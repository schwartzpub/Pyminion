...
# Makes a "pile" for each card type, saved as lists and dictionaries
	...
	def printDeckCards(self):
		...
		print "   [0]" + self.actionCards['card0'][0].cardColor +  self.actionCards['card0'][0].cardName + "\033[0m  " + (" " * (12 - len(self.actionCards['card0'][0].cardName))) + " (" + str(len(self.actionCards['card0'])).zfill(2) + "): $" + str(self.actionCards['card0'][0].cost),
		print "   [5]" + self.actionCards['card5'][0].cardColor +  self.actionCards['card5'][0].cardName + "\033[0m  " + (" " * (12 - len(self.actionCards['card5'][0].cardName))) + " (" + str(len(self.actionCards['card5'])).zfill(2) + "): $" + str(self.actionCards['card5'][0].cost)
		...
		print "   [1]" + self.actionCards['card1'][0].cardColor +  self.actionCards['card1'][0].cardName + "\033[0m  " + (" " * (12 - len(self.actionCards['card1'][0].cardName))) + " (" + str(len(self.actionCards['card1'])).zfill(2) + "): $" + str(self.actionCards['card1'][0].cost),
		print "   [6]" + self.actionCards['card6'][0].cardColor +  self.actionCards['card6'][0].cardName + "\033[0m  " + (" " * (12 - len(self.actionCards['card6'][0].cardName))) + " (" + str(len(self.actionCards['card6'])).zfill(2) + "): $" + str(self.actionCards['card6'][0].cost)
		...
		print "   [2]" + self.actionCards['card2'][0].cardColor +  self.actionCards['card2'][0].cardName + "\033[0m  " + (" " * (12 - len(self.actionCards['card2'][0].cardName))) + " (" + str(len(self.actionCards['card2'])).zfill(2) + "): $" + str(self.actionCards['card2'][0].cost),
		print "   [7]" + self.actionCards['card7'][0].cardColor +  self.actionCards['card7'][0].cardName + "\033[0m  " + (" " * (12 - len(self.actionCards['card7'][0].cardName))) + " (" + str(len(self.actionCards['card7'])).zfill(2) + "): $" + str(self.actionCards['card7'][0].cost)
		print "					    ",
		print "   [3]" + self.actionCards['card3'][0].cardColor +  self.actionCards['card3'][0].cardName + "\033[0m  " + (" " * (12 - len(self.actionCards['card3'][0].cardName))) + " (" + str(len(self.actionCards['card3'])).zfill(2) + "): $" + str(self.actionCards['card3'][0].cost),
		print "   [8]" + self.actionCards['card8'][0].cardColor +  self.actionCards['card8'][0].cardName + "\033[0m  " + (" " * (12 - len(self.actionCards['card8'][0].cardName))) + " (" + str(len(self.actionCards['card8'])).zfill(2) + "): $" + str(self.actionCards['card8'][0].cost)
		print "					    ",
		print "   [4]" + self.actionCards['card4'][0].cardColor +  self.actionCards['card4'][0].cardName + "\033[0m  " + (" " * (12 - len(self.actionCards['card4'][0].cardName))) + " (" + str(len(self.actionCards['card4'])).zfill(2) + "): $" + str(self.actionCards['card4'][0].cost),
		print "   [9]" + self.actionCards['card9'][0].cardColor +  self.actionCards['card9'][0].cardName + "\033[0m  " + (" " * (12 - len(self.actionCards['card9'][0].cardName))) + " (" + str(len(self.actionCards['card9'])).zfill(2) + "): $" + str(self.actionCards['card9'][0].cost)
